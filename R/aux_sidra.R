...
#' @param periods Specifies the desired periods levels. Defaults to 'n1/1' - Brazil.
#' @param variable Specifies the desired variable levels. Defaults to 'n1/1' - Brazil.
